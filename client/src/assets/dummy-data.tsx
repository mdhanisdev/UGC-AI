...
export const faqData = [
    {
        ...
        answer: 'We leverage state-of-art diffusion models trained on millions of product images to blend your product into realistic scenes while preserving details, lighting and reflections.'
    },
    {
...
export const footerLinks = [
    ...
    },
    {
        title: "Connect",
        links: [
            { name: "LinkedIn", url: "https://www.linkedin.com/in/mohammedhanis/" },
            { name: "GitHub", url: "https://github.com/hanisx019" }
        ]
    }
];